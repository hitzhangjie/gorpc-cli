...
type StringRules_Alphabets struct {
	// Alphabets specifies that the field can only contain alphabets
	Alphabets bool `protobuf:"varint,24,opt,name=alphabets,oneof"`
}

type StringRules_Alphanums struct {
	// Alphanums specifies that the field should contain both alphabet(s) and number(s)
	Alphanums bool `protobuf:"varint,25,opt,name=alphanums,oneof"`
}

type StringRules_Lowercase struct {
	// Lowercase specifies that the field can only contain lowercase alphabet(s)
	Lowercase bool `protobuf:"varint,26,opt,name=lowercase,oneof"`
}
...
var file_validate_proto_rawDesc = []byte{
	...
	0x12, 0x1e, 0x0a, 0x09, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x62, 0x65, 0x74, 0x73, 0x18, 0x18, 0x20,
	0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x09, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x62, 0x65, 0x74, 0x73,
	0x12, 0x1e, 0x0a, 0x09, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x6e, 0x75, 0x6d, 0x73, 0x18, 0x19, 0x20,
	0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x09, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x6e, 0x75, 0x6d, 0x73,
	0x12, 0x1e, 0x0a, 0x09, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x63, 0x61, 0x73, 0x65, 0x18, 0x1a, 0x20,
	0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x09, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x63, 0x61, 0x73, 0x65,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x06, 0x77, 0x69, 0x74, 0x68, 0x69, 0x6e, 0x3a, 0x3c, 0x0a, 0x08, 0x64, 0x69,
...
var file_validate_proto_goTypes = []interface{}{
	...
	(*descriptor.OneofOptions)(nil),   // 26: google.protobuf.OneofOptions
